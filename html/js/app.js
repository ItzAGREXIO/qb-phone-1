...
QB.Phone.Functions.SetupApplications = function(data) {
    ...
    $.each(data.applications, function(i, app){
        ...
        if ((!app.job || app.job === QB.Phone.Data.PlayerJob.name) && !blockedapp) {
            ...
            if (app.app == "whatsapp") {
                icon = '<img src="./img/apps/whatsapp.png" class="whatsapp-icon">';
            }
            if (app.app == "phone") {
                icon = '<img src="./img/apps/system_contacts.png" class="phone-icon">';
            }
            if (app.app == "settings") {
                icon = '<img src="./img/apps/system_settings.png" class="settings-icon">';
            }
            if (app.app == "twitter") {
                icon = '<img src="./img/apps/twitter.png" class="twitter-icon">';
            }
            if (app.app == "mail") {
                icon = '<img src="./img/apps/system_email.png" class="mail-icon">';
            }
            if (app.app == "camera") {
                icon = '<img src="./img/apps/system_camera.png" class="camera-icon">';
            }
            if (app.app == "gallery") {
                icon = '<img src="./img/apps/system_gallery.png" class="gallery-icon">';
            }
            if (app.app == "advert") {
                icon = '<img src="./img/apps/yellow_pages.png" class="advert-icon">';
            }
            if (app.app == "bank") {
                icon = '<img src="./img/apps/banksign.png" class="bank-icon">';
            }
            if (app.app == "garage") {
                icon = '<img src="./img/apps/carmudi.png" class="garage-icon">';
            }
            if (app.app == "lawyers") {
                icon = '<img src="./img/apps/barclays.png" class="lawyers-icon">';
            }
            if (app.app == "racing") {
                icon = '<img src="./img/apps/racing.png" class="racing-icon">';
            }
            if (app.app == "crypto") {
                icon = '<img src="./img/apps/crypto.png" class="crypto-icon">';
            }
            if (app.app == "houses") {
                icon = '<img src="./img/apps/housing.png" class="houses-icon">';
            }
    ...
    window.addEventListener('message', function(event) {
        switch(event.data.action) {
            ...
            case "UpdateBank":
                ...
                $(".bank-app-account-balance2").html("&#36; "+event.data.NewBalance);
                $(".bank-app-account-balance2").data('balance', event.data.NewBalance);
                break;
            case "UpdateChat":
                if (QB.Phone.Data.currentApplication == "whatsapp") {
